...
class BitMEXWebsocket:
    ...
    def __wait_for_account(self):
        ...
        while not {'margin', 'position', 'order', 'orderBookL2', 'orderBook10'} <= set(self.data):
            sleep(0.1)
        ...
        try:
            if 'subscribe' in message:
                ...
                if action == 'partial':
                    ...
                    if table not in ['order', 'orderBookL2', 'orderBook10'] and len(self.data[table]) > BitMEXWebsocket.MAX_TABLE_LEN:
